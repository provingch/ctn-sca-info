      ...
      {showList ? <>
        ...
        <section className="panel rooms-list">
          ...
          <div className="table-wrap" role="region" aria-label="Salas y uso en horarios" tabIndex={0}>
            <table className="grade-table rooms-table"><caption className="visually-hidden">Salas, especialidad, uso y acciones</caption><thead><tr><th scope="col">Nombre</th><th scope="col">Especialidad</th><th scope="col">Uso en horarios</th><th scope="col">Acciones</th></tr></thead><tbody>
