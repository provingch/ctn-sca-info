    ...
    <div className="app-header-inner">
      ...
      <div className="navbar-mobile-actions">
        ...
        <NavLink className="navbar-mobile-avatar" to="/profile" aria-label={`Abrir perfil de ${displayName}`}>
          {user?.fotoPerfil ? <img className="navbar-avatar" src={user.fotoPerfil} alt="" /> : (user?.especialidadNombre ? <span className="navbar-avatar" aria-hidden="true"><AvatarEspecialidad name={user.especialidadNombre} size={36} /></span> : <span className="navbar-avatar" aria-hidden="true">{initials}</span>)}
        </NavLink>
