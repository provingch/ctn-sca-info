...
export const saveEtapa2FechaCierre = (planillaId: number, fecha: string) => api.put<void>(`/api/planillas/${planillaId}/etapa2/fecha-cierre`, fecha);
export const confirmEtapa2 = (planillaId: number) => api.post<void>(`/api/planillas/${planillaId}/etapa2/confirmar`, {});
