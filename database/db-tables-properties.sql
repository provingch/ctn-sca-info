...
create database ctndb CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
use ctndb;
SET NAMES utf8mb4;
...
CREATE TABLE horario_slot (
    ...
    CONSTRAINT fk_horario_slot_sala FOREIGN KEY (sala_id)
        REFERENCES sala (id) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- Tokens FCM de la app Android de padres (notificaciones push nativas).
