...
-- Añadir created_at si aún no existe en planilla_rasgo.
...
-- Añadir alumno_email si aún no existe en rasgo_asistencia.
...
-- Añadir estado si aún no existe en rasgo_asistencia.
