...
-- Informática
    ...
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('EDGAR ARTURO', 'ALVAREZ BENITEZ', 35, 7090557, NULL, NULL),
    ('ANNA GABRIELA', 'ARAMBULO GONZALEZ', 35, 7357449, NULL, NULL),
    ('SEBASTIAN', 'BALBUENA GAONA', 35, 7159693, NULL, NULL),
    ('NAOMI ABIGAIL', 'BENITES NOGUERA', 35, 6763142, NULL, NULL),
    ('JOSÉ TOMÁS', 'BENÍTEZ BARRIOS', 35, 7370289, NULL, NULL),
    ('SANTINO RAÚL', 'BENÍTEZ ROA', 35, 7761410, NULL, NULL),
    ('LUCAS SEBASTIAN', 'CACERES CARDOZO', 35, 7726370, NULL, NULL),
    ('MATIAS DANIEL', 'CANDIA ALFONSO', 35, 6950228, NULL, NULL),
    ('ALEJANDRO NICOLAS', 'CENTURION CENTURION', 35, 6719867, NULL, NULL),
    ('SANTIAGO BENJAMIN', 'COCCO FRUTOS', 35, 6740205, NULL, NULL),
    ('SOFÍA', 'DA COSTA VALDEZ', 35, 7304888, NULL, NULL),
    ('JORGE ANDRES', 'DE LA BARRA ZOILAN', 35, 7399317, NULL, NULL),
    ('ELENA ISABELLA EDITH', 'DELGADILLO ESTIGARRIBIA', 35, 7211626, NULL, NULL),
    ('EDUARDO SEBASTIAN', 'DUARTE CASTILLO', 35, 6707283, NULL, NULL),
    ('ELIAN ANDRES', 'ESTIGARRIBIA UGARTE', 35, 6937627, NULL, NULL),
    ('KAREN GUADALUPE', 'FRUTOS MORALES', 35, 6926830, NULL, NULL),
    ('JUAN ENRIQUE', 'LECKIE ROLÓN', 35, 6751503, NULL, NULL),
    ('ANNA MEI', 'NOGUERA PENG', 35, 6870160, NULL, NULL),
    ('NATALIA BELEN', 'NUÑEZ VILLAMAYOR', 35, 7918425, NULL, NULL),
    ('NAHOMI BELÉN', 'OCAMPOS ACOSTA', 35, 6822731, NULL, NULL),
    ('RODRIGO MARTÍN', 'OLMEDO ZÁRATE', 35, 6977116, NULL, NULL),
    ('MARÍA LUJÁN', 'OVELAR CENTURIÓN', 35, 7045854, NULL, NULL),
    ('ALEXIA', 'OVELAR MARTÍNEZ', 35, 6766800, NULL, NULL),
    ('JOSE GIOVANNI', 'PORTILLO RIVEROS', 35, 6887445, NULL, NULL),
    ('JOSUE SEBASTIAN', 'QUINTANA BURGOS', 35, 6887564, NULL, NULL),
    ('ANIBAL', 'RAMIREZ ORTIZ', 35, 6741348, NULL, NULL),
    ('PEDRO DANIEL', 'RECALDE ROMERO', 35, 6864091, NULL, NULL),
    ('ANNELISE MARIA JOSÉ', 'SANABRIA DELPADRE', 35, 7047256, NULL, NULL);

    -- 1º B (curso_id = 36)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('ENRIQUE DAMIÁN', 'ACOSTA MEDINA', 36, 7286222, NULL, NULL),
    ('RODRIGO JAVIER', 'AYALA NAVARRO', 36, 7052595, NULL, NULL),
    ('GUILLERMO DANIEL', 'AYALA OCHIPINTTI', 36, 6803972, NULL, NULL),
    ('SANTIAGO DARIO', 'BÁEZ BORDON', 36, 6805076, NULL, NULL),
    ('JAVIER DE JESUS', 'BOGADO PERALTA', 36, 6754519, NULL, NULL),
    ('FABRIZIO BENJAMÍN', 'CABALLERO VILLANUEVA', 36, 6682833, NULL, NULL),
    ('JORGE BENJAMIN', 'DOMINGUEZ GALEANO', 36, 7088828, NULL, NULL),
    ('FERNANDA ISABEL', 'GALEANO RUIZ DÍAZ', 36, 7484939, NULL, NULL),
    ('HORACIO JOSE', 'GIMENEZ MEZA', 36, 6722653, NULL, NULL),
    ('MARIA JOSÉ', 'GIMENEZ TREVISON', 36, 6852970, NULL, NULL),
    ('LUCAS DANIEL', 'GÓMEZ MORENO', 36, 6698773, NULL, NULL),
    ('GUILLERMO FACUNDO', 'MARTÍNEZ BENÍTEZ', 36, 7313005, NULL, NULL),
    ('RODRIGO DANIEL', 'MARTINEZ MARTINO', 36, 7064807, NULL, NULL),
    ('MARTIN RAFAEL', 'MONGELOS BRITEZ', 36, 7037983, NULL, NULL),
    ('THIAGO ALEXANDER', 'OCAMPOS RIVAS', 36, 6752851, NULL, NULL),
    ('MARCELO JAVIER', 'PÉREZ VELÁZQUEZ', 36, 7228240, NULL, NULL),
    ('ALEXANDER DAVID', 'PORTILLO OLMEDO', 36, 6820649, NULL, NULL),
    ('ALEJANDRO ABEL', 'RIVELA TORALES', 36, 7565497, NULL, NULL),
    ('FABRIZIO ARIEL', 'RODAS CABRERA', 36, 6799915, NULL, NULL),
    ('MARIA ISABEL', 'RODRIGUEZ ACOSTA', 36, 6742018, NULL, NULL),
    ('FACUNDO DANIEL', 'RODRIGUEZ LIMA', 36, 6802446, NULL, NULL),
    ('DULCE MARIA GUADALUPE', 'SAUCEDO PARRA', 36, 6711084, NULL, NULL),
    ('IANN DANIEL', 'TOLEDO ARANDA', 36, 6818642, NULL, NULL),
    ('ISAAC ISMAEL', 'TORALES OVELAR', 36, 6923315, NULL, NULL),
    ('GIULIANNA ARAMI', 'VALDEZ FERNÁNDEZ', 36, 8187153, NULL, NULL),
    ('EZEQUIEL', 'VALENZUELA CABALLERO', 36, 7319899, NULL, NULL),
    ('MATEO RAFAEL', 'VELAZQUEZ AMADI', 36, 7138069, NULL, NULL),
    ('FRANCISCO RAFAEL', 'ZARZA MARTÍNEZ', 36, 6788083, NULL, NULL);
...
-- Construcciones Civiles 1º A (curso_id = 7)
    ...
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('YANINA MARIA PAULA', 'AGÜERO ENCIZO', 7, 6717156, NULL, NULL),
    ('MICAELA', 'BAEZ CORONEL', 7, 6848974, NULL, NULL),
    ('ALEXIA VALENTINA', 'BARBOZA DUARTE', 7, 7150185, NULL, NULL),
    ('BRUNO SEBASTIAN', 'CANDIA BARRETO', 7, 7436812, NULL, NULL),
    ('FABRIZIO JAVIER', 'CANDIA CACERES', 7, 6975857, NULL, NULL),
    ('ALEJANDRA SOLEDAD', 'CARDOZO SEGOVIA', 7, 6764124, NULL, NULL),
    ('PALOMA VALENTINA', 'CHAPARRO ACOSTA', 7, 7015051, NULL, NULL),
    ('GUSTAVO GABRIEL', 'CONTRERA ALARCON', 7, 7179928, NULL, NULL),
    ('DALMA SIRLENE', 'DELVALLE CACERES', 7, 7190512, NULL, NULL),
    ('MILAGROS YERUTI', 'FERREIRA CABRAL', 7, 7154033, NULL, NULL),
    ('RICHARD SAMUEL', 'FERREIRA MAIDANA', 7, 6841677, NULL, NULL),
    ('DANNA VIOLETA', 'GARCIA ALARCON', 7, 6975512, NULL, NULL),
    ('ARIANNA JAZMIN', 'GOMEZ FERLONI', 7, 6778522, NULL, NULL),
    ('FACUNDO LUIS', 'JARA CESPEDES', 7, NULL, NULL, NULL),  -- C.I. 6778522 duplicado en la fuente (Construcciones Civiles A GOMEZ FERLONI, ARIANNA JAZMIN)
    ('SANTINO EZEQUIEL', 'LOPEZ NOTARIO', 7, 6828778, NULL, NULL),
    ('GABRIELA', 'MARTINEZ GUERRERO', 7, 6747934, NULL, NULL),
    ('PABLO RAFAEL DE JESUS', 'MARTINEZ PAREDES', 7, 6637574, NULL, NULL),
    ('PABLO DARIO', 'MARTINEZ RIVEROS', 7, 7132171, NULL, NULL),
    ('ANNA PAULA', 'MENDEZ VERON', 7, 6944953, NULL, NULL),
    ('MICAELA BELEN', 'MIRANDA BORJA', 7, 7173452, NULL, NULL),
    ('ELENA BEATRIZ', 'ORTIZ CORONEL', 7, 6754258, NULL, NULL),
    ('ANGELICA BEATRIZ', 'PAREDES ALONSO', 7, 6886185, NULL, NULL),
    ('MIREIA ABIGAIL', 'RECALDE ACOSTA', 7, 6955012, NULL, NULL),
    ('FIORELLA ARAMI', 'ROA DUARTE', 7, 6776032, NULL, NULL),
    ('STEFANY AYLEM', 'RUIZ DIAZ PRIETO', 7, 7264123, NULL, NULL),
    ('ENZO ARIEL', 'VERA URAN', 7, 6819367, NULL, NULL),
    ('LUANA BELEN', 'VILLALBA RYAN', 7, 6922179, NULL, NULL),
    ('RYN MAIRA', 'YOSHIZAKI NISHIMURA', 7, 6985906, NULL, NULL);

-- Construcciones Civiles 1º B (curso_id = 8)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('FLORY ANAHI', 'AYALA BATTILANA', 8, 8181769, NULL, NULL),
    ('JORGE ALEJANDRO', 'BAREIRO AMARILLA', 8, 7587045, NULL, NULL),
    ('SANTIAGO EMANUEL', 'CERRANO BARRIOS', 8, 6750468, NULL, NULL),
    ('JOHANA ZUNILDA', 'DUARTE ACOSTA', 8, 7654238, NULL, NULL),
    ('FABRIZIO BENJAMIN', 'FARIÑA LOPEZ', 8, 6754566, NULL, NULL),
    ('AMIRA ABIGAIL', 'FERNANDEZ AQUINO', 8, 6703511, NULL, NULL),
    ('THIAGO JAVIER', 'FLEITAS OLAVARRIETA', 8, 7368879, NULL, NULL),
    ('AYELEN GUADALUPE', 'GARCIA CABRERA', 8, 7442884, NULL, NULL),
    ('ANTONELLA MERCEDES', 'GINI GUERRERO', 8, 6671521, NULL, NULL),
    ('LUANA ARAMI', 'GODOY LEZCANO', 8, 6683358, NULL, NULL),
    ('THIAGO JONAS', 'IBAÑEZ GONZALEZ', 8, 7018261, NULL, NULL),
    ('NATHALIA MILAGROS', 'JARA VALDEZ', 8, 6864212, NULL, NULL),
    ('ALMA ARAMI', 'LEZCANO VILLALBA', 8, 7836541, NULL, NULL),
    ('MAIRA MARIEL', 'LOPEZ AVALOS', 8, 7082718, NULL, NULL),
    ('RENATO SEBASTIAN', 'MARTINEZ FARIÑA', 8, 7312674, NULL, NULL),
    ('SOFIA ISABEL', 'MARTINEZ FERREIRA', 8, 6788430, NULL, NULL),
    ('CAMILA BELEN', 'MARTINEZ GAMARRA', 8, 6946279, NULL, NULL),
    ('RAMON', 'MORAY ESPINOZA', 8, 7262559, NULL, NULL),
    ('LUJAN MONSERRATH', 'NUÑEZ MENDEZ', 8, 7643816, NULL, NULL),
    ('MARCOS NAHUEL', 'OCAMPOS ZACARIAS', 8, 7218668, NULL, NULL),
    ('EMMA DAHIANE', 'PORTILLO MALDONADO', 8, 7685486, NULL, NULL),
    ('ANA PATRICIA', 'ROCA ROMAN', 8, 6822676, NULL, NULL),
    ('ALEJANDRA LISSET', 'RODRIGUEZ RAMIREZ', 8, 7358975, NULL, NULL),
    ('ARELI MILENA MICAELA', 'ROJAS BRIZUELA', 8, 7787476, NULL, NULL),
    ('MELINA BEATRIZ', 'SANABRIA FERNANDEZ', 8, 7032065, NULL, NULL),
    ('KASUMI', 'TSUBOI', 8, 7777875, NULL, NULL),
    ('TANYA GISSELLE', 'VESTER BAEZ', 8, 6828953, NULL, NULL);

-- Construcciones Civiles 1º C (curso_id = 9)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('SOL MARIA', 'AGÜERO DELGADO', 9, 7037265, NULL, NULL),
    ('MARIAM FIORELLA', 'AGUIRRE SANTACRUZ', 9, 6967407, NULL, NULL),
    ('KIMBERLY ARAMI', 'ARCE LEZCANO', 9, 7058434, NULL, NULL),
    ('MILAGROS LUJAN', 'BENITEZ MARECOS', 9, 6755762, NULL, NULL),
    ('CARMEN AZUCENA', 'BOBADILLA LOPEZ', 9, 7221051, NULL, NULL),
    ('SOFIA AURORA', 'BORBA BARBIERI', 9, 6887029, NULL, NULL),
    ('MARIA JAZMIN', 'CAMPOS SOSA', 9, 7054951, NULL, NULL),
    ('MELISSA GISSEL', 'CHAPARRO COLMAN', 9, 6975983, NULL, NULL),
    ('ADRIANA MAGALI', 'CHAPARRO ESCURRA', 9, 7614708, NULL, NULL),
    ('YULIANA JAZMIN', 'DUARTE GAONA', 9, 6969295, NULL, NULL),
    ('FABRICIO AMIN', 'FIGUEREDO RIVEROS', 9, 6733785, NULL, NULL),
    ('KATYA ABIGAIL', 'GENES RAMOS', 9, 7474771, NULL, NULL),
    ('PATRCIA ESTHER', 'GONZALEZ CANTERO', 9, 8879705, NULL, NULL),
    ('ROMINA AILEEN', 'GONZALEZ SIUDA', 9, 6885287, NULL, NULL),
    ('TIHANA AYLEN', 'MELGAREJO COLMAN', 9, 6918497, NULL, NULL),
    ('VIVIANA BELEN', 'MORENO ROJAS', 9, 6675391, NULL, NULL),
    ('VICTORIA ELIZABETH', 'NUÑEZ PRIETO', 9, 6900353, NULL, NULL),
    ('GIANNINA MONSERRATH', 'OJEDA IBARRA', 9, 7414532, NULL, NULL),
    ('SOL BEATRIZ', 'ORTEGA FERNANDEZ', 9, 7126227, NULL, NULL),
    ('SOFIA AYELEN', 'QUINTANA VILLALBA', 9, 6923317, NULL, NULL),
    ('SOFIA NICOLE', 'RAMIREZ LEZCANO', 9, 7803037, NULL, NULL),
    ('YERUTI ADRIANA', 'RAMIREZ MAQUEDA', 9, 6819381, NULL, NULL),
    ('SARA REBECA', 'RODRIGUES ORTEGA', 9, 6715107, NULL, NULL),
    ('SOFIA MAGALI', 'SANABRIA ORTIZ', 9, 6883226, NULL, NULL),
    ('AXEL EDUARDO', 'SOSA LEGUIZAMON', 9, 7014987, NULL, NULL),
    ('ALBERT BATISTA', 'VERA CACERES', 9, 7414958, NULL, NULL),
    ('BIA ANTONELLA', 'VILLALBA ARRUA', 9, 7295566, NULL, NULL),
    ('EMILIO EZEQUIEL', 'VILLASANTI DUARTE', 9, 6852619, NULL, NULL);

-- Electricidad 1º A (curso_id = 14)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('KATHERIN LUANA', 'ALVAREZ SANCHEZ', 14, 6876188, NULL, NULL),
    ('BELEN AGUSTINA', 'BARBOZA SANCHEZ', 14, 6646474, NULL, NULL),
    ('DANIEL ALCIDES', 'BENITEZ VERA', 14, 7688456, NULL, NULL),
    ('HORACIO ALEJANDRO', 'CABRERA ESCUDERO', 14, 6761025, NULL, NULL),
    ('JUANJO JONAS', 'CANTERO RECALDE', 14, 6243413, NULL, NULL),
    ('CAMILA MARIA BELEN', 'CHENA BRITEZ', 14, 6781795, NULL, NULL),
    ('KIARA YERUTI', 'CURIN OVELAR', 14, 6915873, NULL, NULL),
    ('VIOLETA NICOL', 'ESPINOLA NUÑEZ', 14, 7782200, NULL, NULL),
    ('ROCIO LIZETTE', 'ESPINOZA CANO', 14, 6699354, NULL, NULL),
    ('ISMAEL SEBASTIAN', 'GARCIA RAMIREZ', 14, 6820980, NULL, NULL),
    ('THIAGO DAVID', 'HERMOSILLA GONZALEZ', 14, 7560587, NULL, NULL),
    ('MARIA DE LOURDES', 'ISIDRE RAMIREZ', 14, 6926728, NULL, NULL),
    ('NICOLAS RENE', 'MACIEL SEGOVIA', 14, 6872763, NULL, NULL),
    ('GLADYS ELIZABETH', 'MAIDANA AQUINO', 14, 6805998, NULL, NULL),
    ('FIORELLA VALENTINA', 'MARTINEZ CANTERO', 14, 7736737, NULL, NULL),
    ('PAULA FLORENCIA', 'MARTINEZ RIVALDI', 14, 7767556, NULL, NULL),
    ('ISABELLA VIVIANA', 'MELGAREJO SAMANIEGO', 14, 7727046, NULL, NULL),
    ('JUAN DARIO DE JESUS', 'MORAN SEGOVIA', 14, 7303084, NULL, NULL),
    ('IVAN RAFAEL', 'NUÑEZ FERNANDEZ', 14, 6818954, NULL, NULL),
    ('MALENA NICOLE', 'OLAZAR JACQUET', 14, 7997098, NULL, NULL),
    ('SANTINO RAFAEL', 'PATIÑO ROLON', 14, 6923039, NULL, NULL),
    ('SOFIA ANABEL', 'PEREZ CARDOZO', 14, 6832656, NULL, NULL),
    ('KLAUS NATHANIEL', 'PINTOS GARCIA', 14, 6795642, NULL, NULL),
    ('BENJAMIN', 'RUSSO RAMIREZ', 14, 7221810, NULL, NULL),
    ('SELENA ALEJANDRA', 'SILVERO GIMENEZ', 14, 7372222, NULL, NULL),
    ('GUSTAVO EMANUEL', 'SOSA DOMINGUEZ', 14, 7045399, NULL, NULL),
    ('ESTEBAN', 'TAMAS MARTINEZ', 14, 6739158, NULL, NULL),
    ('JOAQUIN GONZALO', 'TORRES PAREDES', 14, 6872771, NULL, NULL);

-- Electricidad 1º B (curso_id = 15)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('MIA NAZARENA', 'ACOSTA GIMENEZ', 15, 6952444, NULL, NULL),
    ('ZAIRA FABIOLA', 'ALMIRON RAMIREZ', 15, 6773461, NULL, NULL),
    ('SEBASTIAN ENMANUEL', 'BAEZ MARTINEZ', 15, 7891094, NULL, NULL),
    ('NERY ABEL', 'BENITEZ LOVERA', 15, 6968821, NULL, NULL),
    ('GRACE VALENTINA', 'BOGARIN GOMEZ', 15, 7945223, NULL, NULL),
    ('DEVIN DANIEL', 'CANDIA RIOS', 15, 6995656, NULL, NULL),
    ('ALAN JOSUE', 'FERNANDEZ FIGUEREDO', 15, 7377801, NULL, NULL),
    ('FACUNDO NAHUEL', 'FERREIRA PAREDES', 15, 7001557, NULL, NULL),
    ('DANNA MARIA LUISA', 'GIMENEZ PEREIRA', 15, 7774066, NULL, NULL),
    ('JUAN SEBASTIAN', 'GOMEZ VERA', 15, 6879541, NULL, NULL),
    ('ANIBAL BENJAMIN', 'GOMEZ VILLALBA', 15, 7045543, NULL, NULL),
    ('ADRIAN GABRIEL', 'MARTINEZ VILLALBA', 15, 7163061, NULL, NULL),
    ('YAXENI AILEM', 'MENDIETA AGUIAR', 15, 7231495, NULL, NULL),
    ('LUCAS RAFAEL', 'MEZA RAMOS', 15, 7021434, NULL, NULL),
    ('ANDREA ISABELLA', 'MIERS MONGES', 15, 6645150, NULL, NULL),
    ('SANTIAGO', 'MONTIEL ACOSTA', 15, 6809993, NULL, NULL),
    ('CONSTANZA LUJAN', 'PEREZ ORTIZ', 15, 6960655, NULL, NULL),
    ('SANTIAGO SAMUEL', 'RIQUELME ROJAS', 15, 7602219, NULL, NULL),
    ('AGUSTIN', 'ROJAS DA SILVA MELLO', 15, 6708953, NULL, NULL),
    ('SANTIAGO JOSE', 'ROJAS DIAZ', 15, 7510143, NULL, NULL),
    ('ENZO PAOLO', 'ROLANDI VACCARI', 15, 6508573, NULL, NULL),
    ('MARIA JOSE', 'RUIZ ROMAN', 15, 7099709, NULL, NULL),
    ('MILAGROS ELENA', 'SALINAS DENIS', 15, 7003860, NULL, NULL),
    ('TOBIAS JOEL', 'SOSA VILLALBA', 15, 6714742, NULL, NULL),
    ('JOSE GASPAR', 'TORRES AQUINO', 15, 6931755, NULL, NULL),
    ('ENRIQUE GABRIEL', 'VARGAS FARIÑA', 15, 6888623, NULL, NULL),
    ('ENZO JOAQUIN', 'VILLALBA BENITEZ', 15, 6595379, NULL, NULL),
    ('FIORELLA ABIGAIL', 'VILLAMAYOR ALARCON', 15, 7084076, NULL, NULL);

-- Electrónica 1º A (curso_id = 22)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('ALEXANDER CESAR OSVALDO', 'ACOSTA GUZMAN', 22, 7945565, NULL, NULL),
    ('EMILI LUJAN', 'ARAUJO CACERES', 22, 7918502, NULL, NULL),
    ('EMMA SOPHIA', 'ARGUELLO MONTEGGIA', 22, 7237874, NULL, NULL),
    ('PEDRO ALCIDES', 'BENITEZ ROJAS', 22, 51540489, NULL, NULL),  -- C.I. en la fuente venía como '51540489L'
    ('MARIANA LUJAN', 'BORDABERRY GONZALEZ', 22, 7210062, NULL, NULL),
    ('LUIS ELIAS', 'CASTILLO DUARTE', 22, 8009053, NULL, NULL),
    ('ANA FIORELLA', 'FERREIRA GUERRERO', 22, 6779801, NULL, NULL),
    ('VERONICA GISSELLE', 'GONZALEZ ORTIZ', 22, 6951028, NULL, NULL),
    ('VICTORIA MILAGROS', 'IMAS GALEANO', 22, 7300812, NULL, NULL),
    ('CRISTHIAN ARIEL', 'IRALA MENDOZA', 22, 7656913, NULL, NULL),
    ('REGINA YERUTI', 'JARA MANCUELLO', 22, 7070570, NULL, NULL),
    ('MARGED GUADALUPE', 'KAPPELER FLORES', 22, 7441361, NULL, NULL),
    ('GERARDO MIGUEL', 'LOPEZ ARELLANO', 22, 7012625, NULL, NULL),
    ('CARLOS MARINO DE JESUS', 'LOPEZ MIRANDA', 22, 7543713, NULL, NULL),
    ('DAMIAN EZEQUIEL', 'MARTINEZ DIAZ', 22, 6865557, NULL, NULL),
    ('ELIAS SEBASTIAN', 'MEDINA GONZALEZ', 22, 7070234, NULL, NULL),
    ('MATIAS JOSSUE', 'MONTIEL SANABRIA', 22, 8214428, NULL, NULL),
    ('GUILLERMO DAVID', 'MOURA VALDEZ', 22, 6999696, NULL, NULL),
    ('ALVARO SANTINO', 'PERALTA ARENA', 22, 7639731, NULL, NULL),
    ('ADOLFO MARTIN', 'RAMIREZ VILLALBA', 22, 6791815, NULL, NULL),
    ('MARCOS ADRIAN', 'RIQUELME ARZAMENDIA', 22, 6748509, NULL, NULL),
    ('FACUNDO ADRIAN', 'RODRIGUEZ ESCOBAR', 22, 7020273, NULL, NULL),
    ('JIMENA BELEN', 'RODRIGUEZ GALEANO', 22, 7061706, NULL, NULL),
    ('VALENTINA NOEMI', 'RODRIGUEZ GIMENEZ', 22, 7529213, NULL, NULL),
    ('SANTINO GASPAR', 'TORALES RUIZ', 22, 7083935, NULL, NULL),
    ('GIOVANNA MARIEL', 'VARGAS MORINIGO', 22, 7047499, NULL, NULL),
    ('ALEJANDRO RAFAEL', 'VERA LOPEZ', 22, 6996063, NULL, NULL),
    ('ELENA SOFIA', 'VILLALBA DUARTE', 22, 6700709, NULL, NULL);

-- Electrónica 1º B (curso_id = 23)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('DIEGO JAMAL', 'ACOSTA MEZA', 23, 6625954, NULL, NULL),
    ('MIA COSTANZA', 'ARIAS ALCARAZ', 23, 6784748, NULL, NULL),
    ('LUCAS FERNANDO', 'ARZAMENDIA BENITEZ', 23, 6545514, NULL, NULL),
    ('JONATHAN NEIL', 'AYALA GIMENEZ', 23, 7736647, NULL, NULL),
    ('JAZMIN ARACELI', 'BENITEZ ALVAREZ', 23, 6888492, NULL, NULL),
    ('JUAN CRUZ', 'BRITOS GOMPERTT', 23, 9200232, NULL, NULL),
    ('ALVARO MANUEL', 'CAMBRA RAMOS', 23, 7053206, NULL, NULL),
    ('MIGUEL ANGEL', 'CAREAGA ARANDA', 23, 6850845, NULL, NULL),
    ('MARTIN BENJAMIN', 'CESPEDES LOPEZ', 23, 7005488, NULL, NULL),
    ('AYLEN MAGALI', 'DOMINGUEZ MORENO', 23, 7196898, NULL, NULL),
    ('SANTIAGO EMANUEL', 'DURE CAMPUZANO', 23, 7725881, NULL, NULL),
    ('LUCAS SAMUEL', 'INSAURRALDE ROMERO', 23, 6735637, NULL, NULL),
    ('MIA NAYI', 'LEZCANO FERNANDEZ', 23, 6784849, NULL, NULL),
    ('DARA ABIGAIL', 'LOPEZ SAFFI', 23, 7284295, NULL, NULL),
    ('ENZO FACUNDO', 'MAYEREGGER MARTINEZ', 23, 6735892, NULL, NULL),
    ('FIORELLA AGOSTINA', 'MORAN PEREIRA', 23, 6808172, NULL, NULL),
    ('WISAN DANIEL', 'MOREL CABAÑAS', 23, 6982579, NULL, NULL),
    ('SOFIA ALEJANDRA', 'OJEDA JARA', 23, 7039284, NULL, NULL),
    ('FIORELLA NOEMI', 'ORTELLADO OLMEDO', 23, 6692072, NULL, NULL),
    ('MAX ELIEL', 'OVELAR ORUE', 23, 7549687, NULL, NULL),
    ('HUGO DANILO', 'PEÑA CASTRO', 23, 6744272, NULL, NULL),
    ('SOPHIA MONTSERRAT', 'ROJAS ESPINOZA', 23, 6839945, NULL, NULL),
    ('LUCIA AYMARA', 'ROMERO TESTI', 23, 6987155, NULL, NULL),
    ('JOSE FEDERICO', 'ROMERO VILLALBA', 23, 6994540, NULL, NULL),
    ('JUAN SEBASTIAN', 'SOTELO GONZALEZ', 23, 6974772, NULL, NULL),
    ('SEBASTHIAN', 'TORRADO ORTIZ', 23, 6911813, NULL, NULL),
    ('MAURICIO JOSE', 'VELAZQUEZ VILLALBA', 23, 7134137, NULL, NULL),
    ('DIEGO SEBASTIAN', 'VERA RODRIGUEZ', 23, 7218563, NULL, NULL);

-- Electrónica 1º C (curso_id = 24)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('ALAN EZEQUIEL', 'ALCARAZ PERALTA', 24, 7314702, NULL, NULL),
    ('KARIM MARIA', 'ARENAS ROJAS', 24, 7194609, NULL, NULL),
    ('GONZALO JESUS', 'AVALOS ESCOBAR', 24, 6907656, NULL, NULL),
    ('SHIRLEY LIZBETH', 'AVALOS MARTINEZ', 24, 7021859, NULL, NULL),
    ('LARA VALENTINA', 'BENITEZ AMARILLA', 24, 7567156, NULL, NULL),
    ('MAXIMO VALENTINO', 'CACERES SERAFINI', 24, 6688689, NULL, NULL),
    ('FIORELLA MONTSERRATH', 'CALDERON RAMIREZ', 24, 7471341, NULL, NULL),
    ('LUCIANO ANDRES', 'CAÑETE BOGADO', 24, 6946512, NULL, NULL),
    ('IVAN MOISES', 'CASTILLO VELAZQUEZ', 24, 7089056, NULL, NULL),
    ('JIMMY FABIAN', 'DIAZ RIOS', 24, 7751765, NULL, NULL),
    ('ELIAS ROBERTO', 'DINATALE MENDOZA', 24, 7282481, NULL, NULL),
    ('TADEO EZEQUIEL', 'DOMINGUEZ FRANCO', 24, 6827559, NULL, NULL),
    ('LUCAS AMIN', 'ESPINOLA AGÜERO', 24, 6362876, NULL, NULL),
    ('FERNANDO FABIAN', 'FRANCO MUÑOZ', 24, 6763188, NULL, NULL),
    ('MERCEDES ARAMI', 'GARAY AGÜERO', 24, 7125540, NULL, NULL),
    ('LUCAS DARNELL', 'GIMENEZ PIZURNO', 24, 6852129, NULL, NULL),
    ('FABRIZIO JOEL', 'GUTIERREZ LEZCANO', 24, 6952029, NULL, NULL),
    ('ELIEN ADRIANA', 'LEGUIZAMON', 24, 6766984, NULL, NULL),
    ('EDGAR ALEXANDER', 'MARTINEZ BERNAL', 24, 6817580, NULL, NULL),
    ('JOSIAS EMANUEL', 'MONELLO CUENCA', 24, 8051984, NULL, NULL),
    ('MARTINA MASAMI', 'NAGAI SATO', 24, 7199584, NULL, NULL),
    ('RODRIGO AGUSTIN', 'RIVAROLA DIAZ', 24, 6854460, NULL, NULL),
    ('MELANIE ANAHI', 'ROLON MARTINEZ', 24, 7490290, NULL, NULL),
    ('GIANPAULO SAMUEL', 'TUFARI CHAMORRO', 24, 7005672, NULL, NULL),
    ('SOFIA ELIZABETH', 'TUFARI FLEITAS', 24, 7189239, NULL, NULL),
    ('GABRIELA MONSERRATH', 'VELAZQUEZ DENIS', 24, 7772334, NULL, NULL),
    ('JOAN ANDRES', 'VENIALGO LEGUIZAMON', 24, 6710136, NULL, NULL),
    ('CARLOS ANDRES', 'VILLAMAYOR BARRETO', 24, 7876408, NULL, NULL);

-- Electromecánica 1º A (curso_id = 29)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('SANTIAGO ANDRES', 'AMARILLA PENAYO', 29, 7111290, NULL, NULL),
    ('CECILIA ABIGAIL', 'AMARILLA VELAZQUEZ', 29, 6654197, NULL, NULL),
    ('ALEXANDER GABRIEL', 'ARANDA MARTINEZ', 29, 7504485, NULL, NULL),
    ('JULIETA', 'BAEZ CORONEL', 29, 6848973, NULL, NULL),
    ('ALAN GABRIEL', 'BOGADO ACOSTA', 29, 6778334, NULL, NULL),
    ('JAVIER EZEQUIEL', 'BORDON CACERES', 29, 6978018, NULL, NULL),
    ('GONZALO SEBASTIAN', 'BRITEZ NUÑEZ', 29, 7650546, NULL, NULL),
    ('JOAQUIN DEJESUS', 'DIAZ RUIZ DIAZ', 29, 6844015, NULL, NULL),
    ('DIEGO ESTEBAN', 'DIAZ SANCHEZ', 29, 7001138, NULL, NULL),
    ('DIEGO HERNAN', 'DIAZ SANCHEZ', 29, 7004441, NULL, NULL),
    ('MIGUEL ANGEL', 'ESCOBAR MENDIETA', 29, 6894798, NULL, NULL),
    ('ANA LUCIA ALEJANDRA', 'ESPINOLA HERRERA', 29, 7007200, NULL, NULL),
    ('JEYMI LUJAN', 'GALEANO RODRIGUEZ', 29, 7760193, NULL, NULL),
    ('THOBIAS GABRIEL', 'GUZMAN CACERES', 29, 6611872, NULL, NULL),
    ('CRISTHIAN EDUARDO', 'MALDONADO FERNANDEZ', 29, 6910827, NULL, NULL),
    ('JOAQUIN EZEQUIEL', 'MARIN BAEZ', 29, 7009055, NULL, NULL),
    ('OCTAVIO DANIEL', 'MARTINEZ PRESENTADO', 29, 7383949, NULL, NULL),
    ('SANTIAGO RAFAEL', 'MEDINA GONZALEZ', 29, 7070214, NULL, NULL),
    ('ALEXANDER', 'NOCEDA OH', 29, 8173876, NULL, NULL),
    ('GONZALO SAMUEL', 'NUÑEZ BAREIRO', 29, 6872027, NULL, NULL),
    ('JUAN JOSE', 'OZORIO BRITEZ', 29, 6746572, NULL, NULL),
    ('FLORENCIA ARAMI', 'PENAYO GONZALEZ', 29, 6812274, NULL, NULL),
    ('SEBASTIAN MANUEL', 'PORTILLO CABRERA', 29, 7788249, NULL, NULL),
    ('MARIA VICTORIA', 'RAMUA GONZALEZ', 29, 7321875, NULL, NULL),
    ('ALVARO LUIS', 'ROA MARTINEZ', 29, 7012705, NULL, NULL),
    ('BRUNO ANDRES', 'RUIZ DIAZ VALDIVIA', 29, 6878230, NULL, NULL),
    ('FABRIZZIO VALENTINO', 'VEGA GIMENEZ', 29, 7142100, NULL, NULL),
    ('MARIA JOSE', 'ZALAZAR PAREDES', 29, 7054794, NULL, NULL);

-- Electromecánica 1º B (curso_id = 30)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('RUTH ANAHI', 'AGÜERO ROLON', 30, 7718527, NULL, NULL),
    ('LUCAS ANDRES', 'ALVARES PAREDES', 30, 7383656, NULL, NULL),
    ('SOFIA VALENTINA', 'ARRUA DELVALLE', 30, 7011964, NULL, NULL),
    ('MARIA PAZ', 'BAEZ ROMERO', 30, 7294760, NULL, NULL),
    ('CARLOS DANIEL', 'BORDON BELOTTO', 30, 6692364, NULL, NULL),
    ('AURORA LUCIA', 'BOVEDA SANCHEZ', 30, 6808130, NULL, NULL),
    ('GONZALO DANIEL', 'BRITEZ GAGO', 30, 7325300, NULL, NULL),
    ('MARIO MANUEL', 'CASTILLO BAZAN', 30, 7894915, NULL, NULL),
    ('GIOVANNI SEBASTIAN', 'DIAZ DENIS', 30, 6853580, NULL, NULL),
    ('ELIAS GABRIEL', 'DUARTE PORTILLO', 30, 6886183, NULL, NULL),
    ('IVAN MARCELO', 'ESPINDOLA AYALA', 30, 6692294, NULL, NULL),
    ('ARACELI YERUTI', 'FERNANDEZ RODRIGUEZ', 30, 6663803, NULL, NULL),
    ('GENARO JOSE', 'FLORENTIN CUENCA', 30, 6740177, NULL, NULL),
    ('ALEJANDRA MARIA JOSE', 'GALEANO MARTINEZ', 30, 7504426, NULL, NULL),
    ('LEONARDO ARIEL', 'GARAY LOPFE', 30, 7132189, NULL, NULL),
    ('MARA AYLEEN', 'GUILLEN AMARILLA', 30, 6760198, NULL, NULL),
    ('ANIBAL MAXIMILIANO', 'HULSKAMP ALONSO', 30, 7366522, NULL, NULL),
    ('DANILO BENJAMIN', 'LOPEZ GUERRERO', 30, 7656057, NULL, NULL),
    ('TANIA KIARA', 'MARTINEZ LUGO', 30, 6754238, NULL, NULL),
    ('FABRIZIO AGUSTIN', 'MAZACOTTE REGUNEGA', 30, 7291333, NULL, NULL),
    ('ENZO DAMIAN', 'MERELES VILLALBA', 30, 6805498, NULL, NULL),
    ('BLAS ANGEL MANUEL', 'ORTIZ GALEANO', 30, 6914822, NULL, NULL),
    ('LUCIA ABIGAIL', 'RIVEROS JIMENEZ', 30, 6987889, NULL, NULL),
    ('LUCIANO JOAQUIN', 'RUIZ DIAZ ALVARADO', 30, 6712171, NULL, NULL),
    ('MAURICIO JAVIER', 'SERVIN FERREIRA', 30, 6771163, NULL, NULL),
    ('DANTE DE JESUS', 'VERA MIERES', 30, 7070833, NULL, NULL),
    ('INGRID MONSERRATH', 'VERDUN GONZALEZ', 30, 6879393, NULL, NULL),
    ('EZEQUIEL', 'VILLALBA CHIRIANI', 30, 7551342, NULL, NULL);

-- Mecánica General 1º A (curso_id = 41)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('DIMAS DANIEL', 'ALEGRE BALBUENA', 41, 6852400, NULL, NULL),
    ('LARA ISABEL', 'ARECO ALEGRE', 41, 7086440, NULL, NULL),
    ('ALAN ARTURO', 'CABALLERO ALDERETE', 41, 6987644, NULL, NULL),
    ('EMERSON JAVIER', 'COLMAN LEZCANO', 41, 6781038, NULL, NULL),
    ('OSLIAN AARON', 'CORRO POSSAMAI', 41, 4141479, NULL, NULL),
    ('BARBARA XIMENA', 'ENCISO GIMENEZ', 41, 50704022, NULL, NULL),
    ('JOSE MAURICIO', 'ESCOBAR SERVIN', 41, 6854249, NULL, NULL),
    ('AUGUSTO RAMON', 'GALEANO BENITEZ', 41, 7201107, NULL, NULL),
    ('SAMIRA', 'GARCIA MELLO', 41, 8187103, NULL, NULL),
    ('RONALD JESUS MARIA', 'IRALA ARAUJO', 41, 7218735, NULL, NULL),
    ('CESAR IVAN', 'LEIVA LOPEZ', 41, 7521573, NULL, NULL),
    ('MATHIAS SANTIAGO', 'MARECO AVALOS', 41, 7058029, NULL, NULL),
    ('VICTOR ALEJANDRO', 'MARECO BENITEZ', 41, 7559969, NULL, NULL),
    ('FABIANA MAELI', 'MEDINA FLORENTIN', 41, 6761589, NULL, NULL),
    ('FRANCISCO NAHUEL', 'MENDIETA BAEZ', 41, 7045202, NULL, NULL),
    ('SANTIAGO NICOLAS', 'NARVAEZ RODRIGUES', 41, 7252528, NULL, NULL),
    ('SIMONE ARLETTE', 'ORTIZ SAMANIEGO', 41, 7376068, NULL, NULL),
    ('THIAGO BENJAMIN', 'OSORIO PEREIRA', 41, 6613692, NULL, NULL),
    ('FULGENCIO DE JESUS', 'PALACIOS PAREDES', 41, 7589654, NULL, NULL),
    ('MELISSA ARACELI', 'PEREZ PEREZ', 41, 6776096, NULL, NULL),
    ('TADEO DAVID', 'RECALDE OZORIO', 41, 7330269, NULL, NULL),
    ('RENATE LUJAN', 'RODRIGUEZ BRITEZ', 41, 7315472, NULL, NULL),
    ('LUCAS STEVEN', 'SANABRIA BRITOS', 41, 7084903, NULL, NULL),
    ('GIULIANA LISET', 'SILVESTRI NAVARRO', 41, 7620640, NULL, NULL),
    ('BIANCA GISSEL', 'SOSA CACERES', 41, 6786152, NULL, NULL),
    ('LUANA MAGALI', 'SOTELO FERNANDEZ', 41, 6634192, NULL, NULL),
    ('THIAGO ALBERTO', 'VERA PEREIRA', 41, 7439288, NULL, NULL),
    ('ALMA MARIA', 'ZARATE FRANCO', 41, 6819705, NULL, NULL);

-- Mecánica General 1º B (curso_id = 42)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('FABRICIO ARIEL', 'ACOSTA BENITEZ', 42, 8370995, NULL, NULL),
    ('NOEMI VIOLETA', 'AMARILLA NUÑEZ', 42, 7391135, NULL, NULL),
    ('MIA ARACELI', 'ARGAÑA ROJAS', 42, 7147366, NULL, NULL),
    ('ELIAS IMANOL', 'BELLINO FERREIRA', 42, 7172232, NULL, NULL),
    ('SANTIAGO DANIEL', 'CABALLERO', 42, 7981790, NULL, NULL),
    ('MAURICIO ISAAC', 'DUARTE CASCO', 42, 7134238, NULL, NULL),
    ('ALEJANDRO JAVIER', 'ESTIGARRIBIA RODRIGUEZ', 42, 7469688, NULL, NULL),
    ('ANDREA ELIZABETH', 'FIGUEREDO ROJAS', 42, 6819655, NULL, NULL),
    ('ESTEBAN ALEJANDRO', 'GAMARRA OCAMPOS', 42, 6784666, NULL, NULL),
    ('FRANCO', 'GIRET RIOS', 42, 8872594, NULL, NULL),
    ('AYLEN ABIGAIL', 'GODOY DUARTE', 42, 6626563, NULL, NULL),
    ('MAURICIO JOAQUIN', 'GOMEZ AGUERO', 42, 8181049, NULL, NULL),
    ('SANTIAGO FEDERICO', 'LEZCANO VILLALBA', 42, 6786365, NULL, NULL),
    ('SOFIA AYELEN', 'LOPEZ BENITEZ', 42, 7045473, NULL, NULL),
    ('BRIAN AUGUSTO', 'MARTINEZ GOMEZ', 42, 6783469, NULL, NULL),
    ('FERNANDO AGUSTIN', 'MARTINEZ SANABRIA', 42, 6779072, NULL, NULL),
    ('MAXIMILIANO JESUS', 'MASCAREÑO CABRERA', 42, 7100875, NULL, NULL),
    ('DULCE MARIA', 'NUNES GIMENEZ', 42, 6970343, NULL, NULL),
    ('ANGEL NICOLAS', 'PEDROZO RIVEROS', 42, 8161905, NULL, NULL),
    ('VICTOR ADRIAN NAIM', 'RAMIREZ MEDINA', 42, 51123871, NULL, NULL),
    ('LUCAS SAMUEL', 'ROCHE VERA', 42, 6730545, NULL, NULL),
    ('PAULA ALEXANDRA', 'RODRIGUEZ HAEDO', 42, 6929314, NULL, NULL),
    ('AARON FABIAN', 'RUIZ DIAZ NUÑEZ', 42, 6847418, NULL, NULL),
    ('LUZ FERNANDA', 'SANDOVAL BENITEZ', 42, 7219142, NULL, NULL),
    ('AITOR', 'SILVERA TORRES', 42, 7416251, NULL, NULL),
    ('VICTOR STEVEN', 'SOSA RIQUELME', 42, 6899217, NULL, NULL),
    ('SANTIAGO DANIEL', 'VAZQUEZ MARTINEZ', 42, 6812729, NULL, NULL),
    ('LEANDRO HYUMA', 'WATANABE ISHIZAKI', 42, 7531145, NULL, NULL);

-- Mecánica Automotriz 1º A (curso_id = 47)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('ALEX RICARDO', 'ACOSTA MONTIEL', 47, 7116088, NULL, NULL),
    ('JOEL EZEQUIEL', 'BAEL MEAURIO', 47, 6663091, NULL, NULL),
    ('ISAIAS ISMAEL', 'BENITEZ GOMEZ', 47, 7553594, NULL, NULL),
    ('JUAN ANDRES', 'CABRERA QUIÑONEZ', 47, 6988421, NULL, NULL),
    ('SANTINO DANIEL', 'CARDOZO IBARRA', 47, 7045506, NULL, NULL),
    ('RODNEY JESUS', 'COLMAN CARRERAS', 47, 6740313, NULL, NULL),
    ('FACUNDO JAVIER', 'ENCINA MEDINA', 47, 7335541, NULL, NULL),
    ('BENJAMIN JOSE', 'GARRIDO YAMAMOTO', 47, 7436586, NULL, NULL),
    ('LUCAS EZEQUIEL', 'GONZALEZ CARDOZO', 47, 7812825, NULL, NULL),
    ('FRANCO FABRICIO', 'MASI GHIRINGHELLI', 47, 7102068, NULL, NULL),
    ('JENNIFER LETICIA', 'MAZO AGUILERA', 47, 6871540, NULL, NULL),
    ('GERARDO NICOLAS', 'MENDIETA PEREIRA', 47, 7963092, NULL, NULL),
    ('MARIA JAZMIN', 'MENDOZA FERNANDEZ', 47, 7578415, NULL, NULL),
    ('EVER ISMAEL', 'MENDOZA ROTELA', 47, 6795975, NULL, NULL),
    ('YERUTI ANAHI', 'MORINIGO CANDIA', 47, 6697729, NULL, NULL),
    ('MATEO NICOLAS', 'ORIHUELA GUERRERO', 47, 7242872, NULL, NULL),
    ('ESTEBAN DAVID', 'ORREGO BAEZ', 47, 7008300, NULL, NULL),
    ('VICTORIA', 'ORUE ARGUELLO', 47, 7037487, NULL, NULL),
    ('ENZO RAUL', 'PACUA AZCONA', 47, 6886826, NULL, NULL),
    ('ISAIAS JOSE ALFREDO', 'PEREZ ACOSTA', 47, 6668527, NULL, NULL),
    ('JUAN NICOLAS', 'ROJAS SAMUDIO', 47, 6655453, NULL, NULL),
    ('ANGEL DANIEL', 'ROLON PAREDES', 47, 6963742, NULL, NULL),
    ('MARINA PILAR', 'ROSELLON OVELAR', 47, 8639409, NULL, NULL),
    ('GUSTAVO ADRIAN', 'RUIZ DIAZ OZUNA', 47, 6640211, NULL, NULL),
    ('KAREN YANINA', 'RUIZ FLEITAS', 47, 7715981, NULL, NULL),
    ('JOSHIAS CARLOS', 'SERVIN MEZA', 47, 6923630, NULL, NULL),
    ('JORGE SEBASTIAN', 'TORRES ESCURRA', 47, 6766584, NULL, NULL),
    ('MATIAS NICOLAS', 'VEGA VERA', 47, 6631655, NULL, NULL);

-- Mecánica Automotriz 1º B (curso_id = 48)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('MARCELO DIOSNEL', 'ALONSO BENITEZ', 48, 6978019, NULL, NULL),
    ('CRISTOPHER EMMANUEL', 'AMARILLA DUARTE', 48, 7874727, NULL, NULL),
    ('GAEL BENJAMIN', 'ANZOATEGUI LOPEZ', 48, 7683079, NULL, NULL),
    ('BERNARD TOBIAS', 'ARGUELLO ACOSTA', 48, 6677615, NULL, NULL),
    ('DYLAN GABRIEL', 'BOGARIN OJEDA', 48, 6918909, NULL, NULL),
    ('ALDER DAMIAN', 'BRITEZ AMARILLA', 48, 50494537, NULL, NULL),
    ('DANNA FIORELLA LUJAN', 'CARVALLO SANABRIA', 48, 7146895, NULL, NULL),
    ('MAURICIO LUIS', 'CASCO HERMOSA', 48, 6792469, NULL, NULL),
    ('SOFIA VALENTINA', 'FERNANDEZ RODRIGUEZ', 48, 6849334, NULL, NULL),
    ('ALAN MATIAS', 'FIGUEREDO JARA', 48, 7245061, NULL, NULL),
    ('DULCE MARIA', 'FLEITAS BORDON', 48, 7812876, NULL, NULL),
    ('ELIAS SAMUEL', 'FRAGUEDA OCAMPOS', 48, 6872008, NULL, NULL),
    ('LUIS SAMUEL', 'GIMENEZ LEZCANO', 48, 6976413, NULL, NULL),
    ('ANGEL JHOSIAS', 'GOMEZ OLAZAR', 48, 6766398, NULL, NULL),
    ('JEFFERSON LUIS', 'HUANACUNI CHAMBI', 48, 7086924, NULL, NULL),
    ('SAUL ANDRES', 'LOPEZ ROJAS', 48, 6855462, NULL, NULL),
    ('ALEJANDRO', 'MEDINA GRILLON', 48, 6936727, NULL, NULL),
    ('MATIAS EZEQUIEL', 'MENA MARTINEZ', 48, 7328797, NULL, NULL),
    ('VAHYOLET TATIANA', 'NUÑEZ MARTINEZ', 48, 6970611, NULL, NULL),
    ('THIAGO BENJAMIN', 'OJEDA ORTIGOZA', 48, 7274742, NULL, NULL),
    ('MATEO ADALBERTO', 'ORTIZ MORALES', 48, 7086120, NULL, NULL),
    ('ALEXANDER GABRIEL', 'PINTOS GARCIA', 48, 6795667, NULL, NULL),
    ('MATIAS MANUEL', 'RODRIGUEZ LOPEZ', 48, 6842347, NULL, NULL),
    ('LUCAS GABRIEL', 'ROJAS GALEANO', 48, 7059573, NULL, NULL),
    ('JOHAN SEBASTIAN', 'SANABRIA BORDON', 48, 7002087, NULL, NULL),
    ('DALILA ABIGAIL', 'SCHUBERT MALDONADO', 48, 7610593, NULL, NULL),
    ('RENATO LEONEL', 'VERA LACERNA', 48, 7024789, NULL, NULL),
    ('FELIPE AGUSTIN', 'YBARRA VILLAGRA', 48, 8183134, NULL, NULL);

-- Química Industrial 1º A (curso_id = 55)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('FLORENCIA ISABEL', 'CABRERA MEDINA', 55, 6886888, NULL, NULL),
    ('DALIA NICOLE', 'DELFINI RODRIGUEZ', 55, 7725955, NULL, NULL),
    ('FIORELLA ARAMI', 'FERNANDEZ MUÑOZ', 55, 7022326, NULL, NULL),
    ('DARA GIULIANA', 'GARCIA ALARCON', 55, 6985596, NULL, NULL),
    ('GERARDO RENATO', 'GAYOSO LEZCANO', 55, 7652747, NULL, NULL),
    ('EMILY DANIELA', 'GONZALEZ RAMIREZ', 55, 6886779, NULL, NULL),
    ('JOSELIN ABIGAIL', 'GONZALEZ RIOS', 55, 7019226, NULL, NULL),
    ('VALERIA YERUTI', 'LOPEZ SANCHEZ', 55, 7087469, NULL, NULL),
    ('BIANCA JAZMIN', 'MARTINEZ REYES', 55, 7135570, NULL, NULL),
    ('RACHEL MARICEL', 'MORALES TORRES', 55, 7357923, NULL, NULL),
    ('RENATO EMANUEL', 'NOCEDA PAREDES', 55, 7030305, NULL, NULL),
    ('ANGELICA SUSANA', 'ORUE AYALA', 55, NULL, NULL, NULL),  -- C.I. 6619509 ya asignado a ORUÉ AYALA, ANGÉLICA SUSANA en Informática 2º A (seed)
    ('SANTIAGO', 'ORUE ORTIZ', 55, 6924479, NULL, NULL),
    ('SOFIA ISABEL', 'PAREDES IBERBUDEN', 55, 7441769, NULL, NULL),
    ('JESSICA ISABEL', 'RIVAROLA ALFONZO', 55, 7144183, NULL, NULL),
    ('AMELIA ITATI', 'RODRIGUEZ CANO', 55, 7738907, NULL, NULL),
    ('THIAGO DAVID', 'ROJAS ALVAREZ', 55, 6813121, NULL, NULL),
    ('LUIS MARIA', 'ROLON GOMEZ', 55, 6632926, NULL, NULL),
    ('CECILIA MONTSERRAT', 'RUIZ FLORENTIN', 55, 7027907, NULL, NULL),
    ('SOFIA MAGALY', 'SILGUERO ROA', 55, 6814347, NULL, NULL),
    ('BIANCA ELIZABETH', 'TORALES DUARTE', 55, 6972300, NULL, NULL),
    ('DALVA CAROLINA', 'VALDERRAMA GALEANO', 55, 7721653, NULL, NULL),
    ('OSVALDO AMILCAR', 'VAZQUEZ RATZLAFF', 55, 6846647, NULL, NULL),
    ('ALEXANDER DAVID', 'VILLALBA CABRERA', 55, 7097811, NULL, NULL),
    ('NINNA IRENE', 'VILLALBA DAVALOS', 55, 7758926, NULL, NULL),
    ('ASLIN XIOMARA', 'VILLALBA SOLIS', 55, 6666955, NULL, NULL),
    ('KARIS MANA', 'YOSHIZAKI KUDO', 55, 7041615, NULL, NULL);

-- Química Industrial 1º B (curso_id = 56)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('ADAM ANDRES', 'AMARILLA GONZALEZ', 56, 6739801, NULL, NULL),
    ('FELIX SEBASTIAN', 'AYALA DUARTE', 56, 6993082, NULL, NULL),
    ('DIOGO SANTINO', 'BALBUENA FLORENTIN', 56, 6920559, NULL, NULL),
    ('MATEO VALENTIN', 'BENITEZ FLEITAS', 56, 7619116, NULL, NULL),
    ('ANA CELESTE', 'BERNAL GONZALEZ', 56, 7519907, NULL, NULL),
    ('VANIA JIMENA', 'BOGARIN ALFONSO', 56, 6731321, NULL, NULL),
    ('MARIA PAZ', 'BRITEZ BENITEZ', 56, 6812526, NULL, NULL),
    ('DANNA BRIGYT', 'CONDORI ILLACUTIPA', 56, 7152383, NULL, NULL),
    ('GABRIELA ELIZABETH', 'DIAZ SALINAS', 56, 7332610, NULL, NULL),
    ('STELLA YERUTI', 'DOMINGUEZ PEREZ', 56, 6888232, NULL, NULL),
    ('VALERIA', 'FERNANDEZ BAREIRO', 56, 6780576, NULL, NULL),
    ('FELIPE EDUARDO', 'FERNANDEZ MEDINA', 56, 6856873, NULL, NULL),
    ('LUCIANA ABIGAIL', 'GONZALEZ QUINTANA', 56, 7068151, NULL, NULL),
    ('FABRIZIO DANIEL', 'GONZALEZ VILLAVERDE', 56, 7533831, NULL, NULL),
    ('MIA ROSALBA', 'MARECO RAMIREZ', 56, 6862115, NULL, NULL),
    ('CESAR AUGUSTO', 'MARTINEZ ROLON', 56, 7638594, NULL, NULL),
    ('NOELIA BELEN', 'MENDOZA AYALA', 56, 6751727, NULL, NULL),
    ('LUZ CLARITA', 'NOTARIO RAMIREZ', 56, 6758752, NULL, NULL),
    ('VALENTINA ANAHI', 'PARRA ZARZA', 56, 6998897, NULL, NULL),
    ('ZAHIRA', 'PIOCH RIOS', 56, 77938320, NULL, NULL),  -- C.I. en la fuente venía como '77938320Z'
    ('LUANA ABIGAIL', 'RIVAS JIMENEZ', 56, 6917869, NULL, NULL),
    ('MILENA ABIGAIL', 'ROLON NAVARRO', 56, 6825917, NULL, NULL),
    ('NAOMI MARINA', 'ROTELA AMARILLA', 56, 7134849, NULL, NULL),
    ('SERGIO SEBASTIAN', 'SALCEDO NOGUERA', 56, 6988606, NULL, NULL),
    ('LUANA FIORELLA', 'SILGUERO ALFONZO', 56, 7089457, NULL, NULL),
    ('THAIS JAZMIN', 'VILLALBA ARAUJO', 56, 6603248, NULL, NULL),
    ('LUCIA', 'ZARATE MELGAREJO', 56, 6894894, NULL, NULL);

-- Química Industrial 1º C (curso_id = 57)
    INSERT INTO alumno
    (nombre, apellido, curso_id, ci, correo_encargado, correo_encargado2)
    VALUES
    ('JESUS DANIEL', 'ACOSTA ACOSTA', 57, 7984614, NULL, NULL),
    ('SAMYRA LUZ DARY', 'ADORNO ESTIGARRIBIA', 57, 9089606, NULL, NULL),
    ('HERNAN NICOLAS', 'BENITEZ VARGAS', 57, 9100855, NULL, NULL),
    ('YULIANA ABIGAIL', 'CARDOZO BAEZ', 57, 8342195, NULL, NULL),
    ('DANNA STEFANIA', 'COHENE GALEANO', 57, 6879375, NULL, NULL),
    ('CLAUDIA SOFIA', 'COSCO BRUSICH', 57, 7741132, NULL, NULL),
    ('BIANCA YERUTI', 'DE ARAUJO MARTINEZ', 57, 7783915, NULL, NULL),
    ('JOSE SEBASTIAN', 'ESCOBAR DELGADO', 57, 6888411, NULL, NULL),
    ('NICOLAS DAVID', 'FERNANDEZ BOGADO', 57, 7053046, NULL, NULL),
    ('MARIA ALHELI', 'FERNANDEZ JARA', 57, 6692314, NULL, NULL),
    ('AURORA ELIZABETH', 'FERREIRA MARTINEZ', 57, 7461128, NULL, NULL),
    ('VALENTINA ANAHI', 'GAYOSO LEZCANO', 57, 7652752, NULL, NULL),
    ('ANTONELLA', 'GIMENEZ RAMIREZ', 57, 6719724, NULL, NULL),
    ('RODRIGO NICOLAS', 'GONZALEZ CABALLERO', 57, 6834286, NULL, NULL),
    ('SERENA CHASMIN', 'MARTINEZ ORTIZ', 57, 7723334, NULL, NULL),
    ('CESAR AGUSTIN', 'OZORIO GAONA', 57, 7755238, NULL, NULL),
    ('LUCIA VERONICA', 'PAREDES GALEANO', 57, 7023145, NULL, NULL),
    ('JAZMIN MARIA ANTONELLA', 'QUIÑONEZ GONZALEZ', 57, 7509950, NULL, NULL),
    ('SOFIA MAGALI', 'ROA ESPINOLA', 57, 7090850, NULL, NULL),
    ('NAOMI ROMINA', 'ROJAS RODRIGUEZ', 57, 6730847, NULL, NULL),
    ('JACQUELINE SOLANGE', 'ROLON GONZALEZ', 57, 7379652, NULL, NULL),
    ('FIORELLA MAGALI', 'RUIZ DIAZ ORTIZ', 57, 7307860, NULL, NULL),
    ('FIORELLA LUJAN', 'SANTOS OVIEDO', 57, 6764578, NULL, NULL),
    ('XIMENA LUCIANA', 'SILVA PORTILLO', 57, 7105398, NULL, NULL),
    ('LUCIA JOSEFINA', 'TORRES OCAMPO', 57, 6743961, NULL, NULL),
    ('MAIIA', 'VASILEVA', 57, 9211875, NULL, NULL),
    ('KAVY DOMINIQUE', 'VELLACICH UDRIZAR', 57, 6964850, NULL, NULL),
    ('JULIA', 'VENIALGO STRAHM', 57, 7615856, NULL, NULL);
