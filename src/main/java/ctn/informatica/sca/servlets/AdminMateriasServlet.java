...
public class AdminMateriasServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            java.util.List<ctn.informatica.sca.model.Especialidad> especialidades = new ctn.informatica.sca.dao.EspecialidadDao().findAll();
            ...
            for (Materia m : materias) {
                ...
                for (Integer id : ids) {
                    ctn.informatica.sca.model.Especialidad e = new ctn.informatica.sca.dao.EspecialidadDao().findById(id);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if ("check".equals(action)) {
                ...
                List<Materia> materias = dao.listAll();
                req.setAttribute("materias", materias);
                req.setAttribute("especialidades", new ctn.informatica.sca.dao.EspecialidadDao().findAll());
