...
/**
 * "Mi perfil": edita los mismos campos que `/api/profile/save-profile` en la web
 * para una cuenta padre — nombre/apellido (solo si un admin lo habilita), correo
 * y teléfono. El usuario se muestra de referencia y no se edita desde acá.
 */
...
private fun ProfileForm(ui: ProfileUiState, vm: ProfileViewModel) {
    Column(
        ...
        Text(
            "Estos datos los ve el colegio para comunicarse con vos.",
